...
const ProjectsSearch = () => {
    ...
    const filteredProjects = projectsSearch === "" ? [] :
        projects.filter(project => project.name.toLowerCase().includes(projectsSearch.toLowerCase()))

    return (
        <Transition.Root show={searcher} as={Fragment} afterLeave={() => setProjectsSearch("")}>
            {/* afterLeave va a disparar una acción una vez que se cierre el modal. En este caso, vamos a resetear la búsqueda */}
